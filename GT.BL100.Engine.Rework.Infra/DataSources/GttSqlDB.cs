...
namespace GT.BL100.Engine.Rework.Infra.DataSources
{
    public class GttSqlDB
    {
        ...
        public async Task AddEZMotorsData(string model, string serialNumber, string Volt, string RPM, DateTime DateTimeMotor, string Rev, string lineCode, 
            int re_work, double bearing_Position, double arrow_Position, double hipot_IR, int cw_Speed, double amperage_CW, int ccw_Speed, double amperage_CCW, int ptc_Resistance)
        {
            await _con.ExecuteAsync("INSERT INTO [gtt].[dbo].[MotorsData] ([Modelo], [SerialNumber], [Volt], [RPM], [DateTimeMotor], [Rev], [LineCode], " +
                ...
                "VALUES(@model, @serialNumber, @Volt, @RPM, @DateTimeMotor, @Rev, @lineCode, @re_work, @bearing_Position, @arrow_Position, @hipot_IR, @cw_Speed, @amperage_CW, @ccw_Speed, @amperage_CCW, @ptc_Resistance,1)",
            new {model,serialNumber,Volt,RPM,DateTimeMotor,Rev,lineCode,re_work,bearing_Position,arrow_Position,hipot_IR,cw_Speed,amperage_CW,ccw_Speed,amperage_CCW,ptc_Resistance}).ConfigureAwait(false);
        }
            ...
            int re_work, double bearing_Position, double arrow_Position, double hipot_IR, int cw_Speed, double amperage_CW, int ccw_Speed, double amperage_CCW, int ptc_Resistance)
        {
            await _con.ExecuteAsync("INSERT INTO [gtt].[dbo].[MotorsData] ([Modelo], [SerialNumber], [Volt], [RPM], [DateTimeMotor], [Rev], [LineCode], " +
                "[re_work], [Bearing_Position], [Arrow_Position], [Hipot_IR], [CW_Speed], [Amperage_CW], [CCW_Speed], [Amperage_CCW], [PTC_Resistance],[Pass]) " +
                "VALUES(@model, @serialNumber, @Volt, @RPM, @DateTimeMotor, @Rev, @lineCode, @re_work, @bearing_Position, @arrow_Position, @hipot_IR, @cw_Speed, @amperage_CW, @ccw_Speed, @amperage_CCW, @ptc_Resistance,0)",
            new { model, serialNumber, Volt, RPM, DateTimeMotor, Rev, lineCode, re_work, bearing_Position, arrow_Position, hipot_IR, cw_Speed, amperage_CW, ccw_Speed, amperage_CCW, ptc_Resistance }).ConfigureAwait(false);
        }
