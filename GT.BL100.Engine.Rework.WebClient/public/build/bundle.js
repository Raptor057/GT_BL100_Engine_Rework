    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = text("Velocidad CW:\r\n        ");
    			input4 = element("input");
    			t11 = space();
    			label5 = element("label");
    			t12 = text("Amperaje CW:\r\n        ");
    			input5 = element("input");
    			t13 = space();
    			label6 = element("label");
    			t14 = text("Velocidad CCW:\r\n        ");
    			input6 = element("input");
    			t15 = space();
    			label7 = element("label");
    			t16 = text("Amperaje CCW:\r\n        ");
    			...
    			add_location(input3, file$1, 146, 8, 4212);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*Hipot_IR*/ 8 && to_number(input3.value) !== /*Hipot_IR*/ ctx[3]) {
    				set_input_value(input3, /*Hipot_IR*/ ctx[3]);
    			}

    			if (dirty & /*Cw_Speed*/ 16 && to_number(input4.value) !== /*Cw_Speed*/ ctx[4]) {
    				set_input_value(input4, /*Cw_Speed*/ ctx[4]);
    			}

    			if (dirty & /*Amperage_CW*/ 32 && to_number(input5.value) !== /*Amperage_CW*/ ctx[5]) {
    				set_input_value(input5, /*Amperage_CW*/ ctx[5]);
    			}

    			if (dirty & /*Ccw_Speed*/ 64 && to_number(input6.value) !== /*Ccw_Speed*/ ctx[6]) {
    				set_input_value(input6, /*Ccw_Speed*/ ctx[6]);
    			}

    			if (dirty & /*Amperage_CCW*/ 128 && to_number(input7.value) !== /*Amperage_CCW*/ ctx[7]) {
    				set_input_value(input7, /*Amperage_CCW*/ ctx[7]);
    			}
